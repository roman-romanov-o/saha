...
### Quality
<!-- Use the project's resolved quality tools (see .sahaidachny/stack.yaml or
     auto-detection). The items below are the Python profile; swap for the stack —
     e.g. swiftlint for Swift, eslint + tsc for Node, clippy for Rust. -->
- [ ] Linter: No blocking issues (e.g. ruff / swiftlint / eslint / clippy)
- [ ] Type checker: No type errors in changed code (e.g. ty / tsc — if the stack has one)
- [ ] Complexity: No excessively complex functions
