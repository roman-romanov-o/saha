...
<!-- Write the flow in the PROJECT'S test framework / driver. Acceptance criteria
     tagged verify:manual (UI rendering, visual layout) can't be automated headlessly
     — leave them to human sign-off rather than a brittle E2E spec. -->
